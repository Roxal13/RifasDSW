  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    ?>
      <li class="nav-item active">
        <a class="nav-link" href="/index.php/lista">Lista</a>
      </li>
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="/index.php/crear/rifas">Rifas</a>
          <a class="dropdown-item" href="/index.php/crear/domino">Dominó</a>
      </li>
    <?php
      }
    ?>
